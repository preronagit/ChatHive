...
const LoginPage = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    if (!agreed) {
      setWarning("You must agree to the terms and privacy policy.");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-sm">
      ...
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-white text-5xl font-semibold mt-2 tracking-wide">
          ChatHive
        </h1>
      </div>
      ...
      >
        ...
        {warning && <p className="text-sm text-red-400 -mt-4">{warning}</p>}
